...
goog.provide('PianoForte.Controllers.Courses.MainController');

PianoForte.Controllers.Courses.MainController = function ($scope, $rootScope, filterFilter, CourseService, EnumConverter, FormatManager) {
