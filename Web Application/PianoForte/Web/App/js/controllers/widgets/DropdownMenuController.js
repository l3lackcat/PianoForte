...
goog.provide('PianoForte.Controllers.Widgets.DropdownMenuController');

PianoForte.Controllers.Widgets.DropdownMenuController = function ($scope, $attrs, $element, $document, filterFilter) {
    $scope['element'] = null;
    $scope['filter'] = {
        'result': [],
        'text': '',
