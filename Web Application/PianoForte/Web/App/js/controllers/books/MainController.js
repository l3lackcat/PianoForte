...
goog.provide('PianoForte.Controllers.Books.MainController');

PianoForte.Controllers.Books.MainController = function ($scope, $rootScope, filterFilter, BookService, EnumConverter, FormatManager) {
