...
goog.provide('PianoForte.Controllers.Students.MainController');

PianoForte.Controllers.Students.MainController = function ($scope, $rootScope, filterFilter, StudentService, EnumConverter, FormatManager) {
