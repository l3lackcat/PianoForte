...
goog.provide('PianoForte.Controllers.Teachers.AboutController');

PianoForte.Controllers.Teachers.AboutController = function ($scope, $rootScope, $location, $routeParams, TeacherService, CourseService, Enum, EnumConverter, FormatManager, ValidationManager) {
