...
goog.provide('PianoForte.Controllers.Cds.MainController');

PianoForte.Controllers.Cds.MainController = function ($scope, $rootScope, filterFilter, CdService, EnumConverter, FormatManager) {
